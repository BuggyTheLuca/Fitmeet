...
export function CreateActivity({ closeModal }: { closeModal: () => void }) {
  ...
  const { getActivityTypes, setNewActivity } = useActivity();
  ...
  const handleAdd = async (data: FormData) => {
    ...
    await setNewActivity(formData).then((res) => {
      if(res?.status == 201)
        closeModal();
    })
  };
                ...
                <div className="flex max-w-full flex-col gap-10">
                            ...
                            <FormControl>
                                ...
                                <ul className="flex gap-6 w-max px-4 py-2">
                                    ...
                                    <li
                                        ...
                                        className={`cursor-pointer rounded text-sm transition min-w-[100px] gap-3 ${selectedActivity === activity.id ? 'bg-gray-100' : ''}`}
                                    >
                    ...
                    <FormField
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                            <MapClickMarker setLocal={(latitude: number, longitude: number) => {
